...
# PKG_DEPENDS: bash (>= 4.0), bind9-dnsutils, whois, curl
# PKG_RECOMMENDS: openssl
# PKG_MAINTAINER: Manzolo <manzolo@libero.it>
# PKG_DESCRIPTION: Enhanced domain and DNS information tool
# PKG_LONG_DESCRIPTION: Comprehensive tool for gathering domain information
#  including DNS records, WHOIS data, TLS certificates, and HTTP headers.
#  .
#  Features:
#  - DNS record lookup (A, AAAA, MX, NS, TXT, SOA, CAA, SRV)
#  - WHOIS information retrieval
#  - TLS/SSL certificate details
#  - HTTP/HTTPS header inspection
#  - Subdomain discovery (full mode)
#  - Beautiful colored output
#  - Multiple output modes (standard/full)
