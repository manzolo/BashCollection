...
# PKG_DEPENDS: bash (>= 4.0), whiptail, docker.io | docker-ce
# PKG_RECOMMENDS: docker-compose
# PKG_MAINTAINER: Manzolo <manzolo@libero.it>
# PKG_DESCRIPTION: Interactive Docker management tool with TUI interface
# PKG_LONG_DESCRIPTION: Comprehensive Docker management tool with text-based
#  user interface using whiptail for easy container and image management.
#  .
#  Features:
