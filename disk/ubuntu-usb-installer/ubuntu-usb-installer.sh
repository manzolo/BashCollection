#!/bin/bash
# PKG_NAME: ubuntu-usb-installer
# PKG_VERSION: 2.0.0
# PKG_SECTION: admin
# PKG_PRIORITY: optional
# PKG_ARCHITECTURE: all
# PKG_DEPENDS: bash (>= 4.0), debootstrap, parted, dosfstools
# PKG_RECOMMENDS: qemu-user-static, arch-install-scripts
# PKG_MAINTAINER: Manzolo <manzolo@libero.it>
# PKG_DESCRIPTION: Universal USB installer for Ubuntu and Debian
# PKG_LONG_DESCRIPTION: Multi-mode installer for creating bootable USB drives
#  with Ubuntu Noble or Debian Trixie distributions.
#  .
#  Features:
#  - Full installation, test mode, and chroot modes
#  - Automated partitioning (EFI + root)
#  - Desktop environment installation option
#  - User and root account configuration
#  - GRUB bootloader setup for UEFI
