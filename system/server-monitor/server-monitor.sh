...
# PKG_DEPENDS: bash (>= 4.0), coreutils, procps, sysstat
# PKG_RECOMMENDS: docker.io, lm-sensors
# PKG_MAINTAINER: Manzolo <manzolo@libero.it>
# PKG_DESCRIPTION: Comprehensive server monitoring dashboard with real-time stats
# PKG_LONG_DESCRIPTION: Advanced system monitoring tool that displays comprehensive
#  server statistics in a beautiful colored dashboard format.
#  .
#  Features:
#  - Real-time CPU, memory, and disk usage monitoring
#  - Process listing with resource consumption
#  - Docker container statistics and management
#  - Network interface monitoring
#  - System uptime and load averages
#  - Service status checking
#  - Temperature monitoring (with lm-sensors)
