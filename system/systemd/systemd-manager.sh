#!/bin/bash
# PKG_NAME: systemd-manager
# PKG_VERSION: 1.5.0
# PKG_SECTION: admin
# PKG_PRIORITY: optional
# PKG_ARCHITECTURE: all
# PKG_DEPENDS: bash (>= 4.0), systemd, whiptail
# PKG_MAINTAINER: Manzolo <manzolo@libero.it>
# PKG_DESCRIPTION: Interactive systemd service management tool with TUI
# PKG_LONG_DESCRIPTION: User-friendly tool for managing systemd services
#  with an interactive text-based interface using whiptail.
#  .
#  Features:
...
#  - Filter services by state (running, failed, enabled)
#  - Delete/mask unwanted services
