...
```bash
sudo ./ubuntu_repo_manager.sh setup
```
...
```bash
# Add a .deb package
sudo ./ubuntu_repo_manager.sh add /path/to/package.deb

# Or use interactive mode
sudo ./ubuntu_repo_manager.sh
...
# Remove package
sudo ./ubuntu_repo_manager.sh remove package-name

# List all packages
sudo ./ubuntu_repo_manager.sh list

# Publish changes
sudo ./ubuntu_repo_manager.sh publish

# Show client configuration
sudo ./ubuntu_repo_manager.sh client-config
```
...
```bash
sudo ./ubuntu_repo_manager.sh add mypackage.deb
```
...
# Add to repository
sudo ./ubuntu_repo_manager.sh add mypackage_1.0.deb
```
...
# Remove old version
sudo ./ubuntu_repo_manager.sh remove package-name_old-version
...
# 3. Add to repository
sudo ./ubuntu_repo_manager.sh add hello_1.0.deb
